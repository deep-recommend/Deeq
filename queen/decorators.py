...
from .circuit import QueenGlobalSetting
...
def circuitmacro(func: Union[Callable, str, None] = None,
    ...
    equivalent to this:
        ...
        def egg(c):
            ...
        QueenGlobalSetting.register_macro('egg', egg, allow_overwrite=True)
    ...
    is equivalent with
        ...
        def egg(c):
            ...
        QueenGlobalSetting.register_macro('bacon', egg, allow_overwrite=True)
    ...
    call QueenGlobalSetting.register_macro with allow_overwrite=False.
    ...
    if callable(func):
        ...
        QueenGlobalSetting.register_macro(name, func, allow_overwrite)
        return func
